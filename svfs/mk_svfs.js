...
(async function () {
    ...
    for (const local_file of f_list) {
        ...
        console.log(local_file.file_name, v_path);
        ...
        await appendByteStreamToFile(vfiles_name, buffer); 
    }

    // 3 将元数据也写入本地
    await appendByteStreamToFile(vfiles_metadata_name, JSON.stringify(vfiles_metadata));
})();
